...
model.load_state_dict(torch.load('Weights/model1.pth'))  # 学習済みの重みをロード
...
if __name__ == "__main__":
    ...
    predictions = predict_1(image_path)  # 画像を予測する関数を呼び出す
