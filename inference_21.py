...
model.load_state_dict(torch.load('Weights/model2-1.pth'))  # 学習済みの重みをロード
...
if __name__ == "__main__":
    image_path = "./Dataset/Dataset2-1/単子葉類/image0842.JPG"  # テストする画像のパスを指定
    predictions = predict_21(image_path)  # 画像を予測する関数を呼び出す
    print(predictions)