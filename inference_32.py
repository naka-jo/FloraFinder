...
model.load_state_dict(torch.load('Weights/model3-2.pth'))  # 学習済みの重みをロード
...
if __name__ == "__main__":
    image_path = "./TestData/smartphone/DSC_0007_BURST20231026152958767.JPG"  # テストする画像のパスを指定
    predictions = predict_32(image_path)  # 画像を予測する関数を呼び出す
